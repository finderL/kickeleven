...
define(function(require){
	var Continent = require("../model/continent");
	return taurus.klass("taurus.collection.Continent",Backbone.Paginator.requestPager.extend({
		model:Continent,
