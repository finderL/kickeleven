...
define(function(require){
	...
	return Base.extend({
		tpl:'<%_.each(transfers,function(transfer){%><div class="transfer-summary"><div class="content"><a class="js-player-profile-link user-thumb" href="/#player/<%=transfer.player_id%>/" data-player-id="<%=transfer.player_id%>"><img class="avatar js-action-profile-avatar" src="/static/tmp/none.png" alt="">\
